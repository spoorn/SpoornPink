...
import org.spoorn.spoornpink.world.gen.feature.overworld.trees.DarkPinkBlossomTree;
...
public class SPFeatures {
    ...
    public static AbstractSPTree<SPTreeConfig> DARK_PINK_BLOSSOM_TREE = register("dark_pink_blossom_tree", new DarkPinkBlossomTree(SPTreeConfig.CODEC.stable()));
