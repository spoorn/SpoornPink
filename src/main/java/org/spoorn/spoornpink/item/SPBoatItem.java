...
//    private final SPBoatEntity.Type type;
//
//    public SPBoatItem(SPBoatEntity.Type type, Item.Settings settings) {
//        super(settings);
//        this.type = type;
//    }
//
...
//            SPBoatEntity boatEntity = new SPBoatEntity(world, hitResult.getPos().x, hitResult.getPos().y, hitResult.getPos().z);
