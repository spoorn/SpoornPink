...
//
//    private final Map<SPBoatEntity.Type, Pair<Identifier, BoatEntityModel>> texturesAndModels;
//
//    public SPBoatEntityRenderer(EntityRendererFactory.Context ctx) {
//        super(ctx);
//        this.shadowRadius = 0.8f;
//        this.texturesAndModels = Stream.of(SPBoatEntity.Type.values()).collect(ImmutableMap.toImmutableMap(
//                (type) -> type,
//                (type) -> {
//            return Pair.of(new Identifier(SpoornPink.MODID, "textures/entity/boat/" + type.getName() + ".png"), new BoatEntityModel(ctx.getPart(createBoat(type))));
//        }));
//    }
//
//    @Override
...
//    }
//
//    public static EntityModelLayer createBoat(SPBoatEntity.Type type) {
//        return create("boat/" + type.getName(), "main");
//    }
//
//    private static EntityModelLayer create(String name, String layer) {
//        return new EntityModelLayer(new Identifier(SpoornPink.MODID, name), layer);
//    }
//
//    @Override
